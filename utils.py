...
def get_our_plays_table(our_plays):
    try:
        ...
        df = df[['player_name', 'current_score', 'current_pos', 'top_10']]
        ...
        our_plays_table = our_plays_table.sort_values('current_pos')
        our_plays_table.columns = ['Player', 'Tot', 'Pos','% T10']#,'% Win']
